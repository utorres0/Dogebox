<%-- 
    ...
    Created on : 27/11/2016, 03:54:47 PM
    Author     : oneee
--%>
...
<html>
    ...
    <body  background="img/footer_lodyas.png">
        ...
        <section class="contenido wrapper fondo">
            ...
            <center> <h1>¡Sólo un paso más!</h1></center>
            <br>
            <br>

            <center><h1>En breve recibirás un correo de verificacion para activar tu cuenta y comenzar a usar Dogebox</h1></center>
