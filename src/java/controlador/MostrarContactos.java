 ...
 */
@WebServlet(name = "MostrarContactos", urlPatterns = {"/MostrarContactos"})
public class MostrarContactos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String to = (String) request.getParameter("id");
            if (id == null) {
                ...
                sesion.setAttribute("contactos", list);
                if (to == null) {
                    sesion.setAttribute("contactos", list);
                    response.sendRedirect("contactos.jsp");
                } else {
                    sesion.setAttribute("exito", list);
