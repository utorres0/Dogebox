...
public class EliminarContacto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (idUsuario != null) {
                String eliminarID = request.getParameter("id");
                if (eliminarID == null) {
                    response.sendRedirect("index.jsp");
                } else {
                    //Se valida que hayan introducido datos
                    Conexion c = new Conexion();
                    Connection conn = c.conecta();
                    PreparedStatement eliminar = conn.prepareStatement("DELETE FROM contactos WHERE CO_ID = ? ");
                    eliminar.setInt(1, Integer.parseInt(eliminarID));
